...
export const config = {
  ...
  suites: {
    mainSuite: [
      "./test/specs/mainSuite/01.test.apply.journeys.js",
      "./test/specs/mainSuite/02.test.review-claim-before-mh-launch.journeys.js",
      "./test/specs/mainSuite/03.test.follow-up-claim-before-mh-launch.journeys.js",
      "./test/specs/mainSuite/04.test.pre.mh.journeys.js",
      "./test/specs/mainSuite/05.test.pre.and.post.mh.journeys.js",
      "./test/specs/mainSuite/06.test.beef.journeys.js",
      "./test/specs/mainSuite/07.test.diary.journeys.js",
      "./test/specs/mainSuite/08.test.pigs.journeys.js",
      "./test/specs/mainSuite/09.test.sheep.journeys.js",
      "./test/specs/mainSuite/10.test.claim.session.journeys.js",
      "./test/specs/mainSuite/11.test.dashboard.journeys.js",
      "./test/specs/mainSuite/12.test.backoffice.journeys.js",
    ],
    comp: ["./test/specs/13.test.claim-compliance.journeys.js"],
    compFA: ["./test/specs/14.test.claim-compliance-feature-assurance.journeys.js"],
  },
  // Patterns to exclude.
  exclude: [
